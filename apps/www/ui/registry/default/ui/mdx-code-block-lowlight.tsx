...
export const CodeBlockLowlightView = ({ node, updateAttributes, extension }) => {
  const {
  ...
  const highlightedCode = useMemo(() => {
    ...
    const highlighted = extension.options.lowlight.highlight(language, textContent)
...
export const CodeBlockLowlight = CodeBlock.extend<CodeBlockLowlightOptions>({
  ...
  renderReact({ node }) {
    ...
    const highlighted = this.options.lowlight.highlight(language, node.textContent)
...
export function LowlightPlugin({
  ...
  if (!['highlight', 'highlightAuto', 'listLanguages'].every(api => typeof lowlight[api] === 'function')) {
