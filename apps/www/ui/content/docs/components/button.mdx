...
<ComponentPreview
    name="button-32"
    description="with border muted button"
/>
...
- **`variant`** (`string`, optional): 
  - Defines the visual style of the button. Available options:
    ...
    - **`muted`**: Muted button with no fill.
