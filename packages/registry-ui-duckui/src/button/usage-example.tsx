      ...
      <div className="border rounded-md p-6 bg-gray-50">
        ...
        <div className="grid grid-cols-2 gap-12 place-items-center h-80">
          <div className="w-full flex justify-center">
            <Tooltip 
              content="This tooltip is centered above the button, regardless of content length"
              position="top"
              className="bg-blue-100 border-blue-200"
            >
              <Button variant="outline" className="w-40">Top Position</Button>
            </Tooltip>
          </div>
          ...
          <div className="w-full flex justify-center">
            ...
            >
              <Button variant="outline" className="w-40">Bottom Position</Button>
            </Tooltip>
          </div>
          ...
          <div className="w-full flex justify-center">
            ...
            >
              <Button variant="outline" className="h-20 flex items-center">Left Position</Button>
            </Tooltip>
          </div>
          ...
          <div className="w-full flex justify-center">
            ...
            >
              <Button variant="outline" className="h-20 flex items-center">Right Position</Button>
            </Tooltip>
          </div>
        </div>
      </div>
