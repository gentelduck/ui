...
export interface HoverCardTriggerProps extends React.ComponentPropsWithoutRef<typeof Button> {}

export interface HoverCardContentProps extends React.HTMLProps<HTMLDivElement>, VariantProps<typeof hoverCardVariants> {
