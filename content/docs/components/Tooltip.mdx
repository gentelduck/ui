---
title: Tooltip
description: A versatile and accessible tooltip component that displays additional information related to an element when the element receives keyboard focus or the mouse hovers over it. Ideal for enhancing user interfaces with contextual hints.
component: true
links:
